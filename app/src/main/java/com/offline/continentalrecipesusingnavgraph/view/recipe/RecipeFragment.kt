...
class RecipeFragment : Fragment() {
        ...
        viewModel.recipe.observe(viewLifecycleOwner) {
            ...
            binding.favoriteFab.setOnClickListener{
                ...
                if (isFavorite(recipe)) {
                    binding.favoriteFab.setImageDrawable(getDrawable(view.context, R.drawable.ic_hollow_favorite))
                    viewModel.removeFavoriteMeal(mealEntity)
                } else {
                    binding.favoriteFab.setImageDrawable(getDrawable(view.context, R.drawable.ic_dense_favorite))
    ...
    private fun getMealEntityIfExist(recipe: Recipe): MealEntity {
        ...
        return MealEntity(0, recipe.name ?: "", recipe.thumb ?: "")
    }
